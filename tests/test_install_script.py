...
def test_install_script_noninteractive_openai_default(tmp_path):
    ...
    assert env_payload["L1_MODEL"] == "gemini/gemini-3.1-pro-preview"
    assert env_payload["L2_MODEL"] == "ollama/qwen3:8b"
    assert env_payload["L3_MODEL"] == "ollama/qwen2.5-coder:7b"
